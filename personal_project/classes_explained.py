...
class My_class:
    ...
    #generally don't touch this as all classes have a defualt version of this method
    """
    def __new__(self):
        pass
    """
    ...
    #It is generally bad practice to do more than format argumnts and assign them to attributes
    def __init__(self, name: str):
        self.name = name.capitalize()
        # _hidden attributes are used for internal values that shouldn't be access from outside the object
    ...
    #Methods are functions that a bundled inside of an object
    #They have access to object's attributes and other meotheds through the self variable
    ...
    #Getter methods return a coppy of the _hidden attribute
    #This prevents external functions from modifying the interal value of the _hidden attribute
    ...
    #They act on the class as a whole and don't have access to an objects through the self variable
    #Typically used for helper methods that don't require access to an object's attributess or methoeds
    @staticmethod
    def make_a_title():
        return 'the lame'
