...
@app.route("/front") #<= defines our base URL
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=9001, debug=True) #<= setting the debug to "True" allows us to see changes to our template without restarting our server
