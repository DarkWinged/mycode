...
result = [product[0] for product in c.fetchall()]

# Print the result
# print(result)
[print(product) for product in result] # out results are returned to us in a tuple, uncomment out the above line if you'd like to see that.
